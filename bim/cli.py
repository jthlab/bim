...
@click.option("--wsz", type=int, help="Window size for windowed statistic.")
@click.option("--ssz", type=int, help="Stride size for windowed statistic.")
@click.option("--tsz", type=int, help="Tree-sequence size")
@click.option(
    "--pop",
    type=int,
...
@click.option(
    "--r1t", type=float, default=0, help="l1 penalty for beta-tree", show_default=True
)
@click.option(
    "--r2t", type=float, default=0, help="l2 penalty for beta-tree", show_default=True
)
@click.option(
    "--r1s", type=float, default=0, help="l1 penalty for beta-sfs", show_default=True
)
@click.option(
    "--r2s", type=float, default=0, help="l1 penalty for beta-sfs", show_default=True
)
@click.option(
    "--log_pdf",
...
@click.option("--abeta", type=float, default=0, show_default=True)
def cli(**kwargs):
    """
